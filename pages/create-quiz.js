...
export default function CreateQuiz() {
  ...
  const updateQuestion = (qIndex, field, value, optIndex = null) => {
    ...
    if (optIndex !== null) newQuestions[qIndex].options[optIndex] = value;
    else if (field === 'correct') newQuestions[qIndex].correct = Number(value);
    else newQuestions[qIndex][field] = value;
      ...
      {!code ? (
        <>
          <input
            ...
            style={{ width: '100%', padding: '16px', marginBottom: '30px', fontSize: '1.2rem' }}
          />
        ...
        <div style={{ textAlign: 'center' }}>
          <h2>Código: <strong style={{ fontSize: '3rem' }}>{code}</strong></h2>
